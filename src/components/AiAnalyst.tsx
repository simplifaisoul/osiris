...
interface ChatMessage {
  ...
  timestamp: string;
  isError?: boolean;
  /** From briefing/analyze API — gemini_cloud | local_ai */
...
export default function AiAnalyst({ data }: AiAnalystProps) {
  ...
  const handleSend = useCallback(async () => {
    ...
    try {
      ...
      const srcMeta = normalizeBriefingSourceFields(responseBody);
      ...
      const analystMsg: ChatMessage = {
        ...
        briefingSource: srcMeta.briefingSource,
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-[8px] font-mono text-[var(--text-muted)] leading-relaxed">
                        Your key is stored locally and sent only to the 번개의 눈동자 server. Get a free key at{' '}
                        <a
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5 mb-1.5">
                        ...
                        >
                          {msg.role === 'user' ? 'OPERATOR' : '번개의 눈동자 ANALYST'}
                        </span>
                        {msg.role === 'analyst' && !msg.isError && (() => {
                          const src = normalizeBriefingSourceFields(msg);
